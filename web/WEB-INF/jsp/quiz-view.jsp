...
<html>
    ...
    <body BGCOLOR="#ffe6e6">
        ...
        <c:if test="${requestScope.q ne 'answers'}">
            ...
            <input type='radio' name='ans' value='1' />${requestScope.question.getQue1()}<br />
            <input type='radio' name='ans' value='2' />${requestScope.question.getQue2()}<br />
            <input type='radio' name='ans' value='3' />${requestScope.question.getQue3()}<br />
            <input type='radio' name='ans' value='4' />${requestScope.question.getQue4()}<br />
